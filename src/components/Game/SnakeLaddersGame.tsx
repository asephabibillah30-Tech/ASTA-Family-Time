    ...
    <div className="max-w-4xl mx-auto px-4 py-6 pb-24 space-y-5 animate-pop-in">
      ...
      {showModeModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/80 backdrop-blur-md flex items-center justify-center p-3 sm:p-6 overflow-y-auto animate-pop-in">
          <div className="bg-white dark:bg-slate-800 rounded-2xl sm:rounded-3xl p-4 sm:p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto border-2 sm:border-4 border-emerald-400 dark:border-slate-700 shadow-2xl space-y-3.5 sm:space-y-5 text-center my-auto">
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-tr from-emerald-400 to-teal-500 text-white flex items-center justify-center text-2xl sm:text-3xl mx-auto shadow-lg">
              🐍
            </div>
            <div>
            ...
            <div className="space-y-2.5 sm:space-y-3 pt-1 sm:pt-2">
              <button
                ...
                className="w-full p-3.5 sm:p-4 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-display font-bold text-left shadow-lg active:scale-95 transition-all flex items-center gap-3 border border-emerald-400"
              >
