    ...
    <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 py-4 space-y-6 animate-pop-in">
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 pt-20 sm:pt-24 pb-24 sm:pb-28 bg-slate-950/60 backdrop-blur-xs">
          <div className="relative w-full max-w-md sm:max-w-lg md:max-w-xl rounded-3xl bg-white dark:bg-slate-800 p-5 sm:p-7 shadow-2xl border-3 border-rose-400/40 dark:border-slate-700 max-h-full flex flex-col overflow-hidden animate-pop-in">
            {/* Header */}
