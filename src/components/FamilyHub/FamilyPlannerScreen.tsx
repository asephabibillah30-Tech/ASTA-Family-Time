    ...
    <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 py-4 space-y-6 animate-pop-in">
      ...
      {isAddOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-3 sm:px-4 bg-slate-950/60 backdrop-blur-sm">
          <div className="relative w-full max-w-md sm:max-w-lg md:max-w-xl rounded-3xl bg-white dark:bg-slate-800 p-5 sm:p-7 shadow-2xl border-3 border-blue-400/40 dark:border-slate-700 flex flex-col overflow-hidden animate-pop-in mt-24 mb-20" style={{maxHeight: 'calc(100vh - 180px)'}}>
            {/* Header */}
