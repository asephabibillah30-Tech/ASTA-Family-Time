...
export const ManageFamilyModal: React.FC<ManageFamilyModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 pt-20 sm:pt-24 pb-24 sm:pb-28 bg-slate-950/60 backdrop-blur-xs">
      <div className="relative w-full max-w-lg rounded-3xl bg-white dark:bg-slate-800 p-5 sm:p-7 border-3 border-rose-200 dark:border-slate-700 shadow-2xl max-h-full flex flex-col overflow-hidden animate-pop-in">
