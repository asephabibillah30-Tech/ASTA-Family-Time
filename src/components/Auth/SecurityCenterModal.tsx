  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/60 backdrop-blur-sm">
      <div className="flex min-h-full items-center justify-center p-3 pt-28 pb-24 sm:p-6">
        <div className="relative w-full max-w-lg rounded-3xl bg-white dark:bg-slate-800 p-5 sm:p-7 border-3 border-emerald-400/30 dark:border-slate-700 shadow-2xl flex flex-col overflow-hidden animate-pop-in">
